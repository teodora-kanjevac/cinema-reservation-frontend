<template>
  <div class="max-w-275 mx-auto px-8 py-12 pt-32">
    ...
    <div v-else class="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-7 items-start">
      ...
      <div class="bg-card border border-dark rounded-2xl p-6 sticky top-22.5">
        ...
        <button
          class="w-full py-3.5 rounded-xl text-[15px] font-semibold bg-gold text-base shadow-gold-sm hover:bg-[#f0c85a] hover:shadow-gold-md hover:-translate-y-px transition-all duration-200 mb-2"
          @click="checkout"
        >
          Proceed to Checkout →
        </button>
